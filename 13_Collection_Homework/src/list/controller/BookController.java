...
public class BookController {
	...
	public void insertBook(String title, String author, int category, int price) {
		/*
		 * 1. 매개변수 생성자를 이용하여 Book 객체 생성 (단, 객체 생성 시 장르 번호별로 조건식 이용해서 장르번호가 아닌 장르명으로 생성!)
		 * 2. bookList에 1번의 Book객체 추가
		 */
		
		String cate = null;
		switch(category) {
		case 1: cate = "인문"; break;
		case 2: cate = "자연과학"; break;
		case 3: cate = "의료"; break;
		case 4: cate = "기타"; break;
		}
	...
	public int deleteBook(String title, String author) {
		 ...
		 *    해당 인덱스의 도서 "삭제"하고 result 1로 변경 후 빠져나가기(더이상 반복문을 돌릴 필요없으니깐 break하는게 더 효율적)
		 * 
		 * 3. result 값 반환
		 */
		int result = 0;
